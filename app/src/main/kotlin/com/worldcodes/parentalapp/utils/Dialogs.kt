...
import com.worldcodes.parentalapp.R
import com.worldcodes.parentalapp.data.model.Child
import com.worldcodes.parentalapp.data.preference.DataSharePreference.childPhoto
import com.worldcodes.parentalapp.data.preference.DataSharePreference.childSelected
import com.worldcodes.parentalapp.data.preference.DataSharePreference.deviceChildSelected
import com.worldcodes.parentalapp.utils.ConstFun.alertDialog
import com.worldcodes.parentalapp.utils.ConstFun.find
import com.worldcodes.parentalapp.utils.ConstFun.isShow
import com.worldcodes.parentalapp.utils.ConstFun.setImageUrl
...
object Dialogs {
    ...
    fun Activity.showDialogAccount(list: MutableList<Child>, cancellable: Boolean = true, clickChangePhoto:(() -> Unit)?=null, selected:(dialog:AlertDialog?)->Unit) : AlertDialog{
        ...
        val linearContent = v.find<LinearLayout>(R.id.content_victim)
        val linearSelected = v.find<LinearLayout>(R.id.linear_selected_victim)
        val photoSelected = v.find<CircleImageView>(R.id.photo_selected_victim)
        val nameSelected = v.find<TextView>(R.id.name_selected_victim)
        val deviceSelected = v.find<TextView>(R.id.device_selected_victim)
        val changePhoto = v.find<LinearLayout>(R.id.change_photo_selected_victim)
